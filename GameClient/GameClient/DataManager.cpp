...
void DataManager::DataLoad()
{
	...
	//_dataResources.insert(std::make_pair("loby", Resources::Get()->LoadFBX("Data/FBX/Button.fbx", TOPOLOGY_TRIANGLELIST, RasterState_SOLID)));

	//_dataResources.insert(std::make_pair("Joy", Resources::Get()->LoadFBXBinary("test.noob", TOPOLOGY_TRIANGLELIST, RasterState_SOLID)));

	_dataResources.insert(std::make_pair("Joy", Resources::Get()->LoadFBX("Data/FBX/TestRed.fbx", TOPOLOGY_TRIANGLELIST, RasterState_SOLID)));
